...
def rules() -> list[Rule]:
    return [
        ...
        Rule("011", "公开募集开放式证券投资基金流动性风险管理规定", "03_证监会公募基金一般运作规则", "规范性文件", "中国证监会", "证监会公告〔2017〕12号", "2017-08-31", "2017-10-01", "现行有效", "P0", "是", "正文页", "流动性风险;巨额赎回;流动性工具;估值公允性", sources=[Source("https://www.csrc.gov.cn/csrc/c101877/c1029552/content.shtml")]),
