...
def write_topic_map(rows: list[dict[str, Any]]) -> None:
    topics = {
        ...
        "基金管理人与销售机构治理": ["057", "057A", "060", "056", "056A", "056B", "058", "059", "041", "042"],
        "投资监督": ["001", "005", "008", "011", "020", "026", "018B"],
        "证券交易行为与交易费用": ["002", "017", "018", "018B"],
        "销售机构与销售费用": ["056", "056A", "056B"],
        "风险准备金与风险补偿": ["013"],
        "资产支持证券": ["016"],
        ...
        "信息披露复核": ["009", "010", "011", "012", "023", "053", "053A", "054", "054A"],
        "业绩比较基准与投资风格约束": ["055", "055A", "055B", "058", "009", "053A"],
        "侧袋机制": ["012", "024", "035"],
        ...
        "公募REITs": ["050", "023", "045B", "050A", "050B", "050C", "050D", "050E"],
        "合同与产品文件": ["052", "052A", "052B", "052C"],
        "电子披露与XBRL": ["053", "053A", "053B", "054A"],
